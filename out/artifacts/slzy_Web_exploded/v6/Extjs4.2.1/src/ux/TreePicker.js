...
Ext.define('Ext.ux.TreePicker', {
    ...
    createPicker: function () {
        var me = this,
            picker = new Ext.tree.Panel({
                ...
                columns: me.columns,
                resizable: true, minWidth: 100, maxWidth: 800, minHeight: 200, maxHeight: 500,
    ...
    onExpand: function () {
        ...
        this.picker.setHeight(this.picker.height + 0);
    },
    ...
    setValue: function (value) {
        ...
        if (value === undefined) {
            ...
            // �޸�ԭ������ȡstore�е�record cwj
            //record = me.store.getNodeById(value);//ԭ����
            var root = me.store.getRootNode();
            record = root.findChild(me.valueField, value, true);
        }
