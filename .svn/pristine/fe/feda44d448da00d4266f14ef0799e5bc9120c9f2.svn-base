...
public class Page  implements Serializable
{
	  ...
	  private Long everyPage = Long.valueOf(1L);
	  ...
	  public void pageState(int index, String value)
	  {
	    ...
	    switch (index) {
	    case 0:
	      setEveryPage(Long.valueOf(Long.parseLong(value))); break;
	    case 1:
	      first(); break;
	    case 2:
	      previous(); break;
	    ...
	    case 4:
	      last(); break;
	    case 5:
	      this.sort = Boolean.valueOf(true); sort(value); break;
	    case 6:
	  ...
	  private void previous() {
	    Page tmp1_0 = this; tmp1_0.currentPage = Long.valueOf(tmp1_0.currentPage.longValue() - 1L);
	  }
	  ...
	  private Long getTotalPage(Long totalRecords)
	  {
	    ...
	    if (totalRecords.longValue() % this.everyPage.longValue() == 0L)
	      totalPage = Long.valueOf(totalRecords.longValue() / this.everyPage.longValue());
	    else
	      totalPage = Long.valueOf(totalRecords.longValue() / this.everyPage.longValue() + 1L);
	  ...
	  {
	    this.beginIndex = Long.valueOf((this.currentPage.longValue() - 1L) * this.everyPage.longValue());
	  ...
	  public Long getCurrentPage() {
	    this.currentPage = Long.valueOf((this.currentPage.longValue() == 0L) ? 1L : this.currentPage.longValue());
	  ...
	  public Long getEveryPage() {
	    this.everyPage = Long.valueOf((this.everyPage.longValue() == 0L) ? 10L : this.everyPage.longValue());
	  ...
	  public Long getEndinIndex() {
	    this.endinIndex = Long.valueOf(this.currentPage.longValue() * this.everyPage.longValue());
